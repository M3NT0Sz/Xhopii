...
<body>
  <header class="header2">
    <section class="tudo2">
      <section class="logoTudo">
        <a href="./home.php">
          <section class="logo2"><img src="./img/logo.png" /></section>
  ...
  <section class="pagina2">
    <section class="bloco">
      <form class="blocoTamanho" method="post" action="./processamento/processamento.php">
        <h1>Login</h1>
        ...
        <h3 style="display: flex; justify-content: center;"><?php
        ...
        <section class="outraForma">
          <button><i class='bx bxl-facebook-square'></i>Facebook</button>
