...
<html lang="pt-br">
  ...
  <body>
    ...
    <section class="pagina">
      <section class="fotos">
        <img class="selecionada" src="./img/produto1.png" alt="" />
      ...
      <section class="tudo">
        ...
        <h1 class="preco">R$56,90</h1>
        <p>171 peças dísponiveis</p>
        <p>Modelos:</p>
        <section class="botoes">
          <button class="tudoBotao">Preto</button>
          <button class="tudoBotao">Azul</button>
          <button class="tudoBotao">Verde</button>
          <button class="tudoBotao">Cinza</button>
          <button class="tudoBotao">Rosa</button>
        </section>
        <p>Tamanhos:</p>
        <section class="botoes">
          <button class="tudoBotao">P</button>
          <button class="tudoBotao">M</button>
          <button class="tudoBotao">G</button>
          <button class="tudoBotao">GG</button>
        </section>
